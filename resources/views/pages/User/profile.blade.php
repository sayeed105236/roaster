                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                    ...
                                    <div class="media">
                                        <a href="javascript:void(0);" class="mr-25">
                                            {{-- <img class="round"
                                                ...
                                                height="80" width="80"> --}}
                                            <img src="{{ asset('/storage/employees/' . Auth::user()->image) }}"
                                    ...
                                    <form action="{{ route('user-profile-update') }}" method="POST"
                                        class="mt-2">
                                        @csrf
                                        <input type="hidden" name="user_id" value="{{ Auth::user()->employee->id }}">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="mname"
                                                        value="{{ Auth::user()->employee->mname }}"
                                                        placeholder="Middle Name" required />
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="lname"
                                                        value="{{ Auth::user()->employee->lname }}"
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number"
                                                        value="{{ Auth::user()->employee->contact_number }}"
                                ...
                                <div class="tab-pane fade" id="account-vertical-password" role="tabpanel"
                                    ...
                                    <form action="{{ route('user-change-password-store') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary mr-1 mt-1">Update
                                                    Password</button>
